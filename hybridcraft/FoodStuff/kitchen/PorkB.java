...
public class PorkB extends ItemFood

{
	...
	public PorkB(int par1, int par2, float par3, boolean par4)
	...
	public PorkB(int par1, int par2, boolean par3)
	...
	public PorkB setPotionEffect(int par1, int par2, int par3, float par4)
