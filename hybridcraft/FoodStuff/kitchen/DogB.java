...
public class DogB extends ItemFood

{
	...
	public DogB(int par1, int par2, float par3, boolean par4)
	...
	public DogB(int par1, int par2, boolean par3)
	...
	public DogB setPotionEffect(int par1, int par2, int par3, float par4)
