...
public class BeefB extends ItemFood

{
	...
	public BeefB(int par1, int par2, float par3, boolean par4)
	...
	public BeefB(int par1, int par2, boolean par3)
	...
	public BeefB setPotionEffect(int par1, int par2, int par3, float par4)
