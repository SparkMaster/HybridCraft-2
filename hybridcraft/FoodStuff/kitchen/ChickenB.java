...
public class ChickenB extends ItemFood

{
	...
	public ChickenB(int par1, int par2, float par3, boolean par4)
	...
	public ChickenB(int par1, int par2, boolean par3)
	...
	public ChickenB setPotionEffect(int par1, int par2, int par3, float par4)
	...
	public ChickenB setAlwaysEdible()
