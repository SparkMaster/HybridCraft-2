...
public class ItemCaBFood extends ItemFood

{
	...
	public ItemCaBFood(int par1, int par2, float par3, boolean par4)
	...
	public ItemCaBFood(int par1, int par2, boolean par3)
	...
	public ItemCaBFood setPotionEffect(int par1, int par2, int par3, float par4)
	...
	public ItemCaBFood setAlwaysEdible()
