...
public class ArmorEmerald extends ItemArmor implements IArmorTextureProvider{

 public ArmorEmerald(int par1, EnumArmorMaterial par2EnumArmorMaterial, int par3, int par4) {
