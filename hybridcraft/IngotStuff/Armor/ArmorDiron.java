...
public class ArmorDiron extends ItemArmor implements IArmorTextureProvider{

 public ArmorDiron(int par1, EnumArmorMaterial par2EnumArmorMaterial, int par3, int par4) {
