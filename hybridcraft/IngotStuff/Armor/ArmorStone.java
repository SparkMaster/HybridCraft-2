...
public class ArmorStone extends ItemArmor implements IArmorTextureProvider{

 public ArmorStone(int par1, EnumArmorMaterial par2EnumArmorMaterial, int par3, int par4) {
