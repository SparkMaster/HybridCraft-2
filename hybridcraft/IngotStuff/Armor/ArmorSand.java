...
public class ArmorSand extends ItemArmor implements IArmorTextureProvider{

 public ArmorSand(int par1, EnumArmorMaterial par2EnumArmorMaterial, int par3, int par4) {
