...
public class ArmorStomend extends ItemArmor implements IArmorTextureProvider{

 public ArmorStomend(int par1, EnumArmorMaterial par2EnumArmorMaterial, int par3, int par4) {
