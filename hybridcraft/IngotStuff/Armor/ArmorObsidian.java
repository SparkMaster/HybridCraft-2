...
public class ArmorObsidian extends ItemArmor implements IArmorTextureProvider{

 public ArmorObsidian(int par1, EnumArmorMaterial par2EnumArmorMaterial, int par3, int par4) {
