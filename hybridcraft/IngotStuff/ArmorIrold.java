...
public class ArmorIrold extends ItemArmor implements IArmorTextureProvider{

 public ArmorIrold(int par1, EnumArmorMaterial par2EnumArmorMaterial, int par3, int par4) {
