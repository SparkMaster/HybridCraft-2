...
public class ArmorDirtoneLegs extends ItemArmor implements IArmorTextureProvider{

 public ArmorDirtoneLegs(int par1, EnumArmorMaterial par2EnumArmorMaterial, int par3, int par4) {
