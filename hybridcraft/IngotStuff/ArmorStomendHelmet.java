...
public class ArmorStomendHelmet extends ItemArmor implements IArmorTextureProvider{

 public ArmorStomendHelmet(int par1, EnumArmorMaterial par2EnumArmorMaterial, int par3, int par4) {
