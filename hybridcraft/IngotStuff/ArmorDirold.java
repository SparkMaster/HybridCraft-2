...
public class ArmorDirold extends ItemArmor implements IArmorTextureProvider{

 public ArmorDirold(int par1, EnumArmorMaterial par2EnumArmorMaterial, int par3, int par4) {
