...
public class HybridModIngotStuff implements ICraftingHandler {
	...
	public void onCrafting(EntityPlayer player, ItemStack item, IInventory craftMatrix) {
		...
		if (item.getItem() instanceof hybridcraft.IngotStuff.tool.dirtone.Axe || item.getItem() instanceof hybridcraft.IngotStuff.tool.dirtone.Sword || item.getItem() instanceof hybridcraft.IngotStuff.tool.dirtone.Shovel || item.getItem() instanceof hybridcraft.IngotStuff.tool.dirtone.Pick || item.getItem() instanceof hybridcraft.IngotStuff.tool.dirtone.Hoe) {
		...
		} else if (item.getItem() instanceof hybridcraft.IngotStuff.tool.dirold.Axe || item.getItem() instanceof hybridcraft.IngotStuff.tool.dirold.Sword || item.getItem() instanceof hybridcraft.IngotStuff.tool.dirold.Shovel || item.getItem() instanceof hybridcraft.IngotStuff.tool.dirold.Pick || item.getItem() instanceof hybridcraft.IngotStuff.tool.dirold.Hoe) {
			item.addEnchantment(net.minecraft.src.Enchantment.silkTouch, 1);
			item.addEnchantment(net.minecraft.src.Enchantment.looting, 1);
		} else if (item.getItem() instanceof hybridcraft.IngotStuff.tool.diron.Axe || item.getItem() instanceof hybridcraft.IngotStuff.tool.diron.Sword || item.getItem() instanceof hybridcraft.IngotStuff.tool.diron.Shovel || item.getItem() instanceof hybridcraft.IngotStuff.tool.diron.Pick || item.getItem() instanceof hybridcraft.IngotStuff.tool.diron.Hoe) {
			item.addEnchantment(net.minecraft.src.Enchantment.silkTouch, 1);
			item.addEnchantment(net.minecraft.src.Enchantment.sharpness, 1);
		} else if (item.getItem() instanceof hybridcraft.IngotStuff.tool.dirmend.Axe || item.getItem() instanceof hybridcraft.IngotStuff.tool.dirmend.Sword || item.getItem() instanceof hybridcraft.IngotStuff.tool.dirmend.Shovel || item.getItem() instanceof hybridcraft.IngotStuff.tool.dirmend.Pick || item.getItem() instanceof hybridcraft.IngotStuff.tool.dirmend.Hoe) {
			item.addEnchantment(net.minecraft.src.Enchantment.silkTouch, 1);
			item.addEnchantment(net.minecraft.src.Enchantment.fortune, 1);
		} else if (item.getItem() instanceof hybridcraft.IngotStuff.tool.gomend.Axe || item.getItem() instanceof hybridcraft.IngotStuff.tool.gomend.Sword || item.getItem() instanceof hybridcraft.IngotStuff.tool.gomend.Shovel || item.getItem() instanceof hybridcraft.IngotStuff.tool.gomend.Pick || item.getItem() instanceof hybridcraft.IngotStuff.tool.gomend.Hoe) {
			item.addEnchantment(net.minecraft.src.Enchantment.looting, 1);
			item.addEnchantment(net.minecraft.src.Enchantment.fortune, 1);
		} else if (item.getItem() instanceof hybridcraft.IngotStuff.tool.irmend.Axe || item.getItem() instanceof hybridcraft.IngotStuff.tool.irmend.Sword || item.getItem() instanceof hybridcraft.IngotStuff.tool.irmend.Shovel || item.getItem() instanceof hybridcraft.IngotStuff.tool.irmend.Pick || item.getItem() instanceof hybridcraft.IngotStuff.tool.irmend.Hoe) {
			item.addEnchantment(net.minecraft.src.Enchantment.sharpness, 1);
			item.addEnchantment(net.minecraft.src.Enchantment.fortune, 1);
		} else if (item.getItem() instanceof hybridcraft.IngotStuff.tool.storn.Axe || item.getItem() instanceof hybridcraft.IngotStuff.tool.storn.Sword || item.getItem() instanceof hybridcraft.IngotStuff.tool.storn.Shovel || item.getItem() instanceof hybridcraft.IngotStuff.tool.storn.Pick || item.getItem() instanceof hybridcraft.IngotStuff.tool.storn.Hoe) {
			item.addEnchantment(net.minecraft.src.Enchantment.efficiency, 1);
			item.addEnchantment(net.minecraft.src.Enchantment.sharpness, 1);
		} else if (item.getItem() instanceof hybridcraft.IngotStuff.tool.stold.Axe || item.getItem() instanceof hybridcraft.IngotStuff.tool.stold.Sword || item.getItem() instanceof hybridcraft.IngotStuff.tool.stold.Shovel || item.getItem() instanceof hybridcraft.IngotStuff.tool.stold.Pick || item.getItem() instanceof hybridcraft.IngotStuff.tool.stold.Hoe) {
			item.addEnchantment(net.minecraft.src.Enchantment.efficiency, 1);
			item.addEnchantment(net.minecraft.src.Enchantment.looting, 1);
		} else if (item.getItem() instanceof hybridcraft.IngotStuff.tool.stomend.Axe || item.getItem() instanceof hybridcraft.IngotStuff.tool.stomend.Sword || item.getItem() instanceof hybridcraft.IngotStuff.tool.stomend.Shovel || item.getItem() instanceof hybridcraft.IngotStuff.tool.stomend.Pick || item.getItem() instanceof hybridcraft.IngotStuff.tool.stomend.Hoe) {
			item.addEnchantment(net.minecraft.src.Enchantment.efficiency, 1);
			item.addEnchantment(net.minecraft.src.Enchantment.fortune, 1);
		} else if (item.getItem() instanceof hybridcraft.IngotStuff.tool.irold.Axe || item.getItem() instanceof hybridcraft.IngotStuff.tool.irold.Sword || item.getItem() instanceof hybridcraft.IngotStuff.tool.irold.Shovel || item.getItem() instanceof hybridcraft.IngotStuff.tool.irold.Pick || item.getItem() instanceof hybridcraft.IngotStuff.tool.irold.Hoe) {
			item.addEnchantment(net.minecraft.src.Enchantment.looting, 1);
			item.addEnchantment(net.minecraft.src.Enchantment.sharpness, 1);
		}
	}
