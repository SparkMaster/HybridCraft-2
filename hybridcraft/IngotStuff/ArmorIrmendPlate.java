...
public class ArmorIrmendPlate extends ItemArmor implements IArmorTextureProvider{

 public ArmorIrmendPlate(int par1, EnumArmorMaterial par2EnumArmorMaterial, int par3, int par4) {
