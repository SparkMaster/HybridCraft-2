...
public class ArmorStoneLegs extends ItemArmor implements IArmorTextureProvider{

 public ArmorStoneLegs(int par1, EnumArmorMaterial par2EnumArmorMaterial, int par3, int par4) {
