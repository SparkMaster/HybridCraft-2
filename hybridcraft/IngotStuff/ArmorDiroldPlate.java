...
public class ArmorDiroldPlate extends ItemArmor implements IArmorTextureProvider{

 public ArmorDiroldPlate(int par1, EnumArmorMaterial par2EnumArmorMaterial, int par3, int par4) {
