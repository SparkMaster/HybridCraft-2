...
public class ArmorGomendPlate extends ItemArmor implements IArmorTextureProvider{

 public ArmorGomendPlate(int par1, EnumArmorMaterial par2EnumArmorMaterial, int par3, int par4) {
