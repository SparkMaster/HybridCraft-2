...
public class ArmorGomendHelmet extends ItemArmor implements IArmorTextureProvider{

 public ArmorGomendHelmet(int par1, EnumArmorMaterial par2EnumArmorMaterial, int par3, int par4) {
