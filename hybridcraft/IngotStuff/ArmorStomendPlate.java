...
public class ArmorStomendPlate extends ItemArmor implements IArmorTextureProvider{

 public ArmorStomendPlate(int par1, EnumArmorMaterial par2EnumArmorMaterial, int par3, int par4) {
