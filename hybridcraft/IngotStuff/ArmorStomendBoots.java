...
public class ArmorStomendBoots extends ItemArmor implements IArmorTextureProvider{

 public ArmorStomendBoots(int par1, EnumArmorMaterial par2EnumArmorMaterial, int par3, int par4) {
