...
public class ArmorStorn extends ItemArmor implements IArmorTextureProvider{

 public ArmorStorn(int par1, EnumArmorMaterial par2EnumArmorMaterial, int par3, int par4) {
