...
public class ArmorDirmend extends ItemArmor implements IArmorTextureProvider{

 public ArmorDirmend(int par1, EnumArmorMaterial par2EnumArmorMaterial, int par3, int par4) {
