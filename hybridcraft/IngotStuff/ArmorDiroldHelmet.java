...
public class ArmorDiroldHelmet extends ItemArmor implements IArmorTextureProvider{

 public ArmorDiroldHelmet(int par1, EnumArmorMaterial par2EnumArmorMaterial, int par3, int par4) {
