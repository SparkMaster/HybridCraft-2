...
public class ArmorDirtoneBoots extends ItemArmor implements IArmorTextureProvider{

 public ArmorDirtoneBoots(int par1, EnumArmorMaterial par2EnumArmorMaterial, int par3, int par4) {
