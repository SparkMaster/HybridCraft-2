...
public class ArmorIrmend extends ItemArmor implements IArmorTextureProvider{

 public ArmorIrmend(int par1, EnumArmorMaterial par2EnumArmorMaterial, int par3, int par4) {
