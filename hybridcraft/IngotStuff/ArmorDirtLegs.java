...
public class ArmorDirtLegs extends ItemArmor implements IArmorTextureProvider{

 public ArmorDirtLegs(int par1, EnumArmorMaterial par2EnumArmorMaterial, int par3, int par4) {
