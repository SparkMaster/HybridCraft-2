...
public class ArmorStornHelmet extends ItemArmor implements IArmorTextureProvider{

 public ArmorStornHelmet(int par1, EnumArmorMaterial par2EnumArmorMaterial, int par3, int par4) {
