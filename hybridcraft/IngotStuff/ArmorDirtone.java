...
public class ArmorDirtone extends ItemArmor implements IArmorTextureProvider{

 public ArmorDirtone(int par1, EnumArmorMaterial par2EnumArmorMaterial, int par3, int par4) {
