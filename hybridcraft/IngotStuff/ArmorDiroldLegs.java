...
public class ArmorDiroldLegs extends ItemArmor implements IArmorTextureProvider{

 public ArmorDiroldLegs(int par1, EnumArmorMaterial par2EnumArmorMaterial, int par3, int par4) {
